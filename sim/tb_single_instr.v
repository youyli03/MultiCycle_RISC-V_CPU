...
initial begin
    ...
    // 测试 lh (加载半字)
    data[5]  = 32'h00611483;   // lh x9, 6(x2)     (x9 = 0x5678，有符号扩展)
    data[6]  = 32'h00615483;   // lhu x9, 6(x2)     (x9 = 0x5678，无符号扩展)
    // data[8]  = 32'h00215503;   // lh x10, 2(x2)    (x10 = 0x1234，符号扩展)

    // 测试 lb (加载字节)
    data[7] = 32'h00714483;   // lbu x9, 7(x2)    (x12 = 0x78，符号扩展)
    data[8] = 32'h00710483;   // lb x9, 7(x2)    (x13 = 0x56，符号扩展)

    // 测试 sw (存储字)
    data[9]  = 32'h00612623;   // sw x6, 12(x2)    (data[22] = x6 = 0x12345678)
    data[10] = 32'h00612623;   // sw x6, 12(x2)    (data[23] = x6 = 0x87654321)

    // 测试 sh (存储半字)
    data[11] = 32'h00611923;   // sh x6, 18(x2)    (data[24] = 0x43210000)
    data[12] = 32'h00611823;   // sh x6, 16(x2)    (data[24] = 0x43214321)

    // 测试 sb (存储字节)
    data[13] = 32'h006108a3;   // sb x6, 17(x2)   (data[24] = 0x43212121)
    data[14] = 32'h006107a3;   // sb x6, 15(x2)   (data[23] = 0x21654321)
