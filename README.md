...
- [MultiCycle RISC-V CPU](#multicycle-risc-v-cpu)
  - [目录](#目录)
  - [架构概述](#架构概述)
    - [模块层次](#模块层次)
  - [目录结构](#目录结构)
  ...
  - [存储器映射](#存储器映射)
  - [外设说明](#外设说明)
    - [GPIO（`0xF000_0000`）](#gpio0xf000_0000)
    - [UART（`0xF000_1000`）](#uart0xf000_1000)
    - [定时器（`0xF000_2000`）](#定时器0xf000_2000)
  - [快速上手](#快速上手)
    - [1. 编译软件](#1-编译软件)
    - [2. 生成仿真内存初始化文件](#2-生成仿真内存初始化文件)
    - [3. 综合到 GOWIN FPGA](#3-综合到-gowin-fpga)
  - [仿真](#仿真)
  - [目标硬件](#目标硬件)
  - [License](#license)
